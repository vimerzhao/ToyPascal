...
public class Pascal
{
    ...
    private boolean assign;             // true to print assignment tracing.
    private boolean fetch;              // true to print fetch tracing.
    private boolean call;               // true to print call tracing.
    private boolean returnn;            // true to print return tracing.
